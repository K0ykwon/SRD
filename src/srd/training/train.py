...
def run_tiny_train(
    ...
    return {
        ...
        "refresh_enabled": config.refresh_enabled if config.model_type == "srd_block_refresh" else config.use_refresh,
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--preset",
        default=None,
        help="Named preset: local_tiny, srd_tiny, srd_suf_tiny, block_refresh_local_tiny, block_refresh_tiny, block_refresh_suf_tiny",
    )
